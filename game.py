...
def apply_board_event(player, position):
    ...
    board_events = {
        ...
        6: ("you went by the water, a whale stole your wallet", 'lose', 5),
        7: ("You got pickpocketed of $2!", 'lose', 2),
        8: ("A theif ran up to you and took your money", 'lose', 2),
        9: ("A kind lady thought you were homeless and gave you a dollar", 'gain', 1),
        10: ("You found a hidden stash of coins!", 'gain', 3),
        11: ("A millionaire asked for some money, and didnt pay you back", 'lose', 7),
        12: ("A kind stranger gave you $5!", 'gain', 5),
        13: ("Jordan Palermo took 2 dollars from you", 'lose', 2),
        14: ("Angel Fre was gonna give you some money, but shes also broke", 'gain', 0),
        15: ("You received a small inheritance!", 'gain', 8),
        16: ("Mr Mazey gave you a dollar", 'gain', 1),
        17: ("You invested in a small company but it ended up doing terribly", 'lose', 4),
        18: ("You stepped on a street vendor's merchandise and had to pay a $3 fine!", 'lose', 3),
        19: ("Chelsea Nicolas gave the Joes enough money to give you some", 'gain', 2),
        20: ("You tried to compete in a competetion, but Bianca Mastroviti beat you", 'lose', 5),
        21: ("Lost your wallet! $5 gone!", 'lose', 5),
        22: ("Suprise car break down!", 'lose', 15),
        23: ("You pickpocketed a 5 year old", 'gain', 3),
        24: ("Won a small bet on a street game!", 'gain', 4),
        25: ("You found a winning lottery ticket worth $10!", 'gain', 10),
        26: ("Jada Philip punched you and took your money", 'lose', 2),
        27: ("This is a really lucky spot! but not for you", 'lose', 5),
        28: ("Had to pay for an emergency taxi ride: $3!", 'lose', 3),
        29: ("You helped an old lady cross the street, she wasnt thet grateful but you begged her and she gave in", 'gain', 1),
        30: ("A rogue tax collector took $4 from you!", 'lose', 4),
        31: ("Angel Fre got mugged and the robber gave you the money", 'gain', 2),
        32: ("Roblox sued you for being so bad at every game", 'lose', 10),
        33: ("Found some forgotten cash in an old coat pocket!", 'gain', 2),
        34: ("Aliah Auxelus donated her entire life saving, which was only a dollar", 'gain', 1),
        35: ("You gambled your future kids college funds! You won!", 'gain', 3),
        36: ("Paid a surprise utility bill: $6!", 'lose', 6),
        37: ("You gambled your future kids college funds! You lost..", 'lose', 5),
        38: ("You did a quick chore for a shop owner and earned $2!", 'gain', 2),
        39: ("A talking dog told you to get a job, a cat overheard and felt bad, then gave you some money", 'gain', 2),
        40: ("Invested in a good cause, and it paid off! Gained $7!", 'gain', 7),
        41: ("Invested in a bad cause, but it still paid off somehow???", 'gain', 3),
